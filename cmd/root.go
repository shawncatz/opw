...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.opw.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".opw" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".opw")
	}
